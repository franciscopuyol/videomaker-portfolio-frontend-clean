...
export default function Bio() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-x-hidden">
      <CustomCursor />
      <Navigation activeSection="bio" />
      
      
      
      <div className="relative z-10 pt-24 md:pt-32 pb-16 md:pb-20 px-4 md:px-6">
        <div className="w-full">
          {/* Full Width Layout */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-16 min-h-screen">
            ...
            <div className="lg:col-span-2 flex flex-col justify-between">
              ...
              <div>
                ...
                >
                  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black leading-tight text-white mobile-header-fix site-title" style={{ fontFamily: '"Satoshi Black", "General Sans Black", "Inter Black", system-ui, sans-serif', fontWeight: 900, letterSpacing: '-0.015em', lineHeight: 1.1 }}>
                    {heroTitle}
                  </h1>
                </motion.div>
